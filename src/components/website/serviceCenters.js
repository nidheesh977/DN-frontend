      ...
      <div id="service_centers">
        <Container className={`${All.Container} ${All.pr_xs_30} ${All.pl_xs_50}`}>
          <Row id="s_c_filter">
            ...
            <Col xs={12} sm={6} md={6} lg={3} xl={3}>
              <ul>
                <li className='s_c_dropdown_title'>Area Name</li>
                <li>
                  <div id="select_area" className='service_center_filter' onClick={() => dropDown(3)}>
                    {this.state.selected_area
                    ? this.state.selected_area
                    : this.state.area_list[0]
                ...
                <li>
                  <div class="s_c_dropdown-content" id="s_c_dropdown3">
                    {this.state.area_list.map((area, index) => {
                      return (
                        <li onClick={() => selectArea(area)} key={index}>{area}</li>
                      )
                    })}
                  </div>
                </li>
          ...
          <Row>
            <Col>
              <ul>
                <li className='s_c_list_title'>Service centers {this.state.selected_area? "in " + this.state.selected_area:"near you"}</li>
              </ul>
            </Col>
            <Col>
              <ul>
                <li className='s_c_location'><img src={locationIcon} alt="" style = {{paddingRight: "10px", float: "left"}}/>{this.state.selected_area ? this.state.selected_area : this.state.area_list[0]}, {this.state.selected_state ? this.state.selected_state : this.state.state_list[0]}.</li>
              </ul>
            </Col>
          </Row>
