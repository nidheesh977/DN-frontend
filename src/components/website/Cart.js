...
export default function Cart(props) {
  ...
  useEffect(() => {
    ...
    axios.get(`https://demo-nexevo.in/haj/auth-app/public/api/auth/${slug}/download?user_id=${userId}`, config)
      .then(res => {
        setCart(res.data);
      },
        err => {
  ...
  async function displayRazorpay() {
    ...
    const result = await axios.get(`https://demo-nexevo.in/haj/auth-app/public/api/auth/${slug}/download?user_id=${userId}`);
    ...
    const options = {
      ...
      handler: async function (response) {
        ...
        const result = await axios.post("https://demo-nexevo.in/haj/auth-app/public/api/auth/downloadpayment", data)
          .then(res => res.data)
          .then((data) => {
