...
console.log(response.data)       
  ...
  return (
    <div>
      <div id="toHide" style={{fontSize: "22px", fontFamily: "muli-regular", textAlign:"center", marginTop:"35px", display:"none"}}>YAY!! No Rejected Videos, Thank you for following the rules</div>
   <Row gutterWidth={12}>
          {value.map((item) => {
            return (
...
export default Pilot_rejectedVideos;
