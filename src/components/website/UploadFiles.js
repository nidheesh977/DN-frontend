...
class UploadFiles extends Component {
  ...
  checkNewKeywordSubmit = (e) => {
    if(
      e.key == "Enter" && this.state.new_keyword!="" && 
      !this.state.selected_files_details[this.state.file_edit].keywords.includes(this.state.new_keyword)
    )
    {
      var files_details = this.state.selected_files_details
  ...
  removeSelectedKeyword = (keyword) => {
    ...
    var keywords = this.state.selected_files_details[this.state.file_edit].keywords
                ...
                <Row className={All.margin_0}>
                  ...
                  >
                    <div id="u_f_details_input">
                      ...
                      {this.state.files_selected
                        ? <div className='u_f_input_keywords_container'><div className={this.state.selected_files_details[this.state.file_edit].usage == "free" ? 'u_f_file_usage_selected u_f_file_usage' : "u_f_file_usage"} id="u_f_file_usage1" onClick={() => this.changeUsage("free")}>Free</div>
                          <div className={this.state.selected_files_details[this.state.file_edit].usage == "paid" ? 'u_f_file_usage_selected u_f_file_usage' : "u_f_file_usage"} id="u_f_file_usage2" onClick={() => this.changeUsage("paid")}>Paid</div></div>
                      ...
                      {this.state.files_selected
                        ...
                        : <input type="text" name="" id="u_f_category" className='u_f_input_field' disabled/>
                      }
                      <div className="u_f_input_title">Explore your experience <span className='u_f_input_title_optional'>(Optional)</span></div>
                      {this.state.files_selected
                        ...
                        : <textarea name="" id="u_f_textarea" cols="30" rows="10" className='u_f_textarea' disabled></textarea>
                      }
                      <div className="u_f_input_title">Keywords</div>
                      <input type="text" name="" id="u_f_new_keyword" className='u_f_input_field' onChange = {this.newKeywordChange} onKeyUp={this.checkNewKeywordSubmit} disabled = {!this.state.files_selected} value = {this.state.new_keyword}/>
                      {this.state.files_selected
                      &&<div className='u_f_input_keywords_container'>
                        {this.state.selected_files_details[this.state.file_edit].keywords.map((keyword, index) => {
                          return(
                            <div className="u_f_input_keywords" onClick={() => this.removeSelectedKeyword(keyword)}>{keyword} <i class="fa fa-check" aria-hidden="true"></i></div>
                          )
                        })}
                      </div>
                      }
                      ...
                      {this.state.files_selected
                        ? <div className="u_f_input_18plus"><label><input type="checkbox" name="" id="" onChange={this.changeAdultContent} checked={this.state.selected_files_details[this.state.file_edit].adult_content} />Confirm 18+ viewable?</label></div>
                        : <div className="u_f_input_18plus"><label><input type="checkbox" name="" id="" disabled/>Confirm 18+ viewable?</label></div>
                      }
                      <div id="u_f_btn">
              ...
              >
                ...
                <DialogContent className={All.PopupBody} style={{ marginBottom: "50px" }}>
                  ...
                  <Row style={{ marginTop: "30px" }}>
                    <div className="u_f_popup_title">You have draft files in your account. Do you want to continue upload</div>
                    <div className="u_f_popup_btn_container">
                      <button className="u_f_popup_btn1" onClick={this.continueEdit}>Continue edit</button>
                      <button className="u_f_popup_btn2" onClick={this.uploadNew}>Upload new</button>
                    </div>
                  </Row>
                </DialogContent>
              </Dialog>
