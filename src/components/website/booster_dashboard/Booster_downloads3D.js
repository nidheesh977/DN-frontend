...
let [media, setMedia] = useState([])
  ...
  return (
    <div>
      <div id="toHide" style={{fontSize: "22px", fontFamily: "muli-regular", textAlign:"center", marginTop:"35px", display:"none"}}>No Downloaded 3D Images, Download and check back</div>
        <Row gutterWidth={12}>
          {media.map((item, i) => {
            return (
              <>
...
export default Booster_downloads3d;
