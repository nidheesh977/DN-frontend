...
export class Company_hiredClosed extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [
                  ...
                  <Row>
                    <Col>
                      <div className="h_p_listing_img_container">
                        ...
                        />
                        <div className="company_rateBtn">Rate Pilot</div>
                      </div>
                      ...
                      <div className="h_p_listing_pricing_rating">
                        ...
                        <div className="h_p_listing_btn_container">
                          ...
                          <button className="h_p_save_pilot_btn1">
                ...
                >
                  <Row>
                    <Col>
                      ...
                      <div className="company_rateBtn" style={{float: "right"}}>Rate Pilot</div>
                      ...
                      <div className="h_p_listing_pricing_rating_sm">
                        ...
                        <div className="h_p_listing_btn-container" style={{marginTop : "10px"}}>
                          <button
...
export default Company_hiredClosed;
