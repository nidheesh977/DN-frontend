...
import Tick from "./images/done-white.svg";
import Like from "./images/heart-white.svg";
import Close from "./images/close_white.svg";

export class Company_hiredOnProcess extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [
                    ...
                    <Col>
                      ...
                      <div className="h_p_others_container">
                        <div
                          ...
                          onClick={() => this.pilotDetailPage(i)}
                        >
                          {item.name}
                        </div>
                      ...
                      <div className="h_p_listing_pricing_rating">
                        ...
                        <div className="h_p_listing_btn_container" style={{marginBottom: "10px"}}>
                          <button className="h_p_save_pilot_btn2">
                            <img src={Tick} />
                          </button>
                          <button
                            className="h_p_save_pilot_btn3"
                            style={{ margin: "0px 15px" }}
                          >
                            <img src={Close} />{" "}
                          </button>
                          <button className="h_p_save_pilot_btn4">
                            <img src={Like} />{" "}
                          </button>
                        </div>
...
export default Company_hiredOnProcess;
