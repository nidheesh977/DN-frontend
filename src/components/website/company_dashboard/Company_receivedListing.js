...
function Company_receivedListing() {
  let profiles = {
    listing: [
      {
        id: 1,
            ...
            <div>
              <div style={{ margin: "0px 0px 40px 0px" }}>
                ...
                <div>
                  <div className="pd_a_j_dataDateHead">
                    Applied on:
                    <span className="pd_a_j_dataDate">{items.applied}</span>
                  </div>
                </div>
                <div className="pd_a_j_data_subTitle1">{items.producer}</div>
                <div>
                  ...
                  <div className="a_j_listing_text1">{items.desc}</div>
                </div>
                <div className="a_j_listing_btns" style={{ marginTop: "20px" }}>
                  ...
                  <Link
                    to="/company_dashboard/activities/received/applications"
                    id="a_j_job_btn1"
                  >
                    View Candidates
                  </Link>{" "}
...
export default Company_receivedListing;
