...
class Like extends React.Component {
  ...
  componentDidMount(){ 
    ...
    const config = {
      headers: {
        ...
        .then(res => this.setState({ user: res.data }, () => { 
                axios.get(`http://localhost/auth-app/public/api/auth/likecheck/${id}/${res.data.id}`,config).then(res => res.data)
                       .then((data) => { 
    ...
    axios.get(`http://localhost/auth-app/public/api/auth/postlikes/${id}`, config)
    .then(res => {    
  ...
  updateLikes = num => {
    ...
    axios.get(`http://localhost/auth-app/public/api/auth/post/like/${id}`, config)
    .then(res => {  
    })  
